      ...
      message: {
        productMessage: {
          product: {
            ...
            title: "Murphy-Fakereply", //Kasih namalu
...
`;
        sendButImage(from, menu, "Jangan lupa subcribe yt MurphyBotz", thumb, [
          {
        ...
        break;
      case "owner":
        sendKontak(from, owner, "Murphy", "Sibuk");
        break;
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
